...
#define BUILDING_TEXTURE_ROWCOUNT 8

#define TILE_TEXTURE_SIZE 4
#define TILE_TEXTURE_SURFACE (TILE_TEXTURE_SIZE * TILE_TEXTURE_SIZE)
#define BUILDING_TEXTURE_SIZE (TILE_TEXTURE_SIZE * BUILDING_TEXTURE_ROWCOUNT)
...
#define CHUNK_SURFACE (CHUNK_SIZE*CHUNK_SIZE)
#define SIM_AREA (SIM_SIZE*SIM_SIZE)
